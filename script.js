...
const perguntarAI = async (apiKey, game, question) => {
  ...
  const pergunta = `
    ...
    - Considere a data atual ${new Date().toLocaleDateString()} e faça pesquisas atualizadas sobre o patch atual, baseado na data atual, para dar uma resposta coherente.
    - Nunca responda itens que voce não tenha certeza de que existe no patch atual.

    ## Resposta
    - Economice na resposta, seja direto e responda no minimo 500 caracteres. 
